...
```{r, eval = F}
library(edgeR)
count1 = readRDS('simcount1.rds') 
count2 = readRDS('simcount2.rds')
...
```{r, eval = F}
exp1 = readRDS(file = 'interactionMatrix_exp1.rds')
exp2 = readRDS(file = 'interactionMatrix_exp2.rds')
back1 = readRDS(file = 'interactionMatrix_back1.rds')
back2 = readRDS(file = 'interactionMatrix_back2.rds')
head(exp1)
```
...
```{r, eval = F}
library(openxlsx)
dat = read.xlsx(xlsxFile ='~/Dropbox/database search in proteomics/data/Archaea database Search Results - updated/Archaea Mascot Targets 100_FDR.xlsx')
dat_decoy = read.xlsx(xlsxFile ='~/Dropbox/database search in proteomics/data/Archaea database Search Results - updated/Archaea Mascot DECOYS 100_FDR.xlsx')
str(dat)
```
...
re = Clipper(score.exp = score,
               ...
               FDR = 0.01,
               analysis = 'enrichment')
head(match[re$discoveries[[1]]]) ### identified matches
```
